...
extension VerificationStateX on VerificationState {
  String get statusLabel => switch (this) {
        ...
        VerificationState.faceVerifying => "Memverifikasi identitas...",
        VerificationState.faceVerified => "Identitas berhasil diverifikasi",
  ...
  String get instruction => switch (this) {
        VerificationState.ready =>
          "Pastikan wajah Anda terlihat jelas, lalu mulai verifikasi",
        VerificationState.starting => "Menyiapkan sesi verifikasi",
        VerificationState.faceVerifying =>
          "Memverifikasi identitas...",
        VerificationState.faceVerified => "Silakan ambil obat",
